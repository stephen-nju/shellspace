...
# 4B的模型
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 vllm serve /opt/nas/p/mmu/nanjing/models/Qwen_models/Qwen2.5-14B-Instruct --served-model-name Qwen2.5-14B-Instruct --tensor-parallel-size 8 --port 8810 --max-model-len 32768
